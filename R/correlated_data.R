...
#' def <- defData(def, varname="xNorm", formula="xUni * 2", dist="normal",
#'                variance=8)
#'
#' dt <- genData(250, def)
#'
...
#' sigma <- c(1, 2, 3)
#'
#' dtAdd <- addCorData(dt, "myID", mu = mu, sigma = sigma,
#'                     rho = .7, corstr = "cs")
#' dtAdd
#'
...
#' @examples
#' defC <- defData(varname = "nInds", formula = 50, dist = "noZeroPoisson",
#'                 id = "idClust")
#'
#' dc <- genData(10, defC)
#' #### Normal only
