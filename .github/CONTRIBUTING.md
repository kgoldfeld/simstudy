...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("kgoldfeld/simstudy", fork = TRUE)`.
...
*   New code should follow the tidyverse [style
    guide](https://style.tidyverse.org) but with camelCase instead of snake_case. 
