...
A parameterization of the structure of these block correlation matrices is described by [Li *et al*](https://journals.sagepub.com/doi/pdf/10.1177/0962280220932962){target="_blank"} and has been implemented in these two functions. The options for the block matrices depend on the distinction between  *cross-sectional* vs *cohort* samples as well as the *exchangeability* vs. *decay* patterns of correlation. 
